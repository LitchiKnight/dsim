...
def create_parser() -> ArgumentParser:
  ...
  run.add_argument("-th", "--thread", type=str, default="5", help="the number of threads executing in parallel")
  ...
  run.add_argument("--timeout", type=str, default="1800", help="simulation time limit")
